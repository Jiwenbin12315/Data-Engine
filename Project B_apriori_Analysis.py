...
# 对Transaction进行排序
data = data.sort_values(by=['订单日期','客户ID'],axis=0,ascending=True, inplace= False)
# 修改中文标题
data.rename(columns={'产品名称':'Item','客户ID':'Transaction'}, inplace = True)
# 去掉none项
